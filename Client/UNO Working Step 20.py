...
uno_button_rect = uno_button_image.get_rect(topleft=(1620, 900))  # Adjust the position to fit
...
def draw_game():
    ...
    # Draw arrow buttons
    left_arrow_rect = left_arrow_image.get_rect(topleft=(10, 700))  # Lowered y-coordinate
    right_arrow_rect = right_arrow_image.get_rect(topright=(screen.get_width() - 90, 700))  # Lowered y-coordinate
